<script lang="ts">
	// Source: https://codepen.io/davidkpiano/pen/xLKBpM
</script>

<div class="house" id="house" data-rooms="4">
	<div class="house-wings" data-flip-key="wings">
		<div class="house-left-wing">
			<div class="house-window" />
			<div class="house-window" />
			<div class="house-sparkle">
				<div class="house-sparkle-dots" />
			</div>
		</div>
...
<style lang="scss">
	$color-primary: #892222;
	$color-roof: #bd1919;
	$color-ledge: #d8c34f;
	$color-window-left: #eaebbd;
	$color-window-right: #eaebbd;
