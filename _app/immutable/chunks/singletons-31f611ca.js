import { B as noop, s as safe_not_equal } from "./index-91e48c8d.js";
import { a as assets } from "./paths-e8c03176.js";
...
function get_link_info(a, base) {
  ...
  const external = !url || is_external_url(url, base) || has.rel_external || has.target || has.download;
